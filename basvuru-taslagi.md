...
**The loop.**
144 of the library's translations are already deposited on Zenodo with CC-BY-SA DOIs (as of 18 August 2026) — a first, concrete instance of closing the loop the tool describes: *the graph measures the gap → the library translates the text → the translation re-enters the graph → the graph can measure again.*

...
**The question.**
Kadim Kütüphane (kadimkutuphane.com) publishes Turkish translations of 844 primary sources of the Western esoteric tradition — texts like the Corpus Hermeticum, Picatrix, and Templar rituals — openly, with translations deposited on Zenodo with DOIs under open Creative Commons licences (CC BY 4.0, some CC BY-SA 4.0). But who studies these texts scientifically? What does the international research landscape around them look like, and where does Turkish-language scholarship sit inside it? We built a small, reproducible tool — the *Boşluk Atlası* (Translation-Gap Atlas) — to ask the OpenAIRE Graph directly, work by work.
...
**The loop.**
144 of the library's translations are already deposited on Zenodo with DOIs under open CC licences (as of 18 August 2026) — a first, concrete instance of closing the loop the tool describes: *the graph measures the gap → the library translates the text → the translation re-enters the graph → the graph can measure again.*
